...
setEPS()
postscript("../output/figures/figure_1_temp.eps")
...
dev.off()
setEPS()
postscript("../output/figures/figure_1_precip.eps")
par(mar=c(5.1,4.6,4.1,2.1), cex.lab=1.25, cex.axis=1.25, cex=1.25)
...
dev.off()
setEPS()
postscript("../output/figures/figure_1_temp_seas.eps")
par(mar=c(5.1,4.6,4.1,2.1), cex.lab=1.25, cex.axis=1.25, cex=1.25)
plot.herb("tseas.975", data, by=500, xlim=c(0,15000), xlab="Temperature Seasonality")
text(1000, 1, "(e)", font=2)
dev.off()
setEPS()
postscript("../output/figures/figure_1_precip_seas.eps")
par(mar=c(5.1,4.6,4.1,2.1), cex.lab=1.25, cex.axis=1.25, cex=1.25)
plot.herb("pseas.975", data, by=20, xlim=c(0,200), xlab="Precipitation Seasonality")
text(10, 1, "(f)", font=2)
dev.off()
setEPS()
postscript("../output/figures/figure_1_lat_lower.eps")
par(mar=c(5.1,4.6,4.1,2.1), cex.lab=1.25, cex.axis=1.25, cex=1.25)
...
dev.off()
setEPS()
postscript("../output/figures/figure_1_lat_upper.eps")
par(mar=c(5.1,4.6,4.1,2.1), cex.lab=1.25, cex.axis=1.25, cex=1.25)
